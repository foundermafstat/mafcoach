...
import { MessageSquare, User, ChevronDown, Award, LogOut, Settings, Database, History, LayoutGrid } from "lucide-react"
...
export default function Header() {
  ...
  return (
    <header className="border-b bg-mafia-950 text-white">
      <div className="container mx-auto px-4 py-3 flex items-center justify-between">
        ...
        <div className="flex items-center gap-3">
          ...
          >
            <MessageSquare className={isAIChatVisible ? "text-mafia-300" : "text-white"} />
          </Button>
